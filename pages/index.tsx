    ...
    return (
        <div className="absolute inset-0 bg-zinc-900">
            <div className="items-center flex flex-col justify-center h-full">
                ...
                <h2 className="text-slate-300 text-sm font-medium lg:text-xl py-2 font-mono font-semibold">
                ...
                <footer className="absolute bottom-5 text-slate-300 cursor-pointer space-x-4 font-mono font-semibold">
